...
public class SendSms {
    public static CommResult sendSms(String phone,String verifyCode) throws ClientException {
        System.out.println(phone+"-->"+verifyCode);
...
//请求失败这里会抛ClientException异常
        ...
        if(sendSmsResponse.getCode() != null && sendSmsResponse.getCode().equals("OK")) {
            ...
            commResult = new CommResult(1,sendSmsResponse.getCode());
            return  commResult;
        }
    }
}
